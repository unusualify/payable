...
class IyzicoService extends PaymentService
{
    ...
    public function generateHeadersV2($request, $uri)
    {
        $header = [
            'Accept' => 'application/json',
            'Content-type' => 'application/json',
    ...
    protected function prepareAuthorizationString($request, $rnd)
    {
        ...
        return vsprintf('IYZWS %s:%s', [$this->apiKey, $authContent]);
    }
    ...
    public function prepareAuthorizationStringV2(?Request $request, $randomString, $uri)
    {
